      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm" style={{ color: 'rgba(15,23,42,0.6)' }}>
            <a href="#wisdom-economy" className="hover:text-cyan-600 transition-colors">Wisdom Economy</a>
            <a href="#excellence" className="hover:text-cyan-600 transition-colors">Excellence</a>
            <a href="#investraders" className="hover:text-cyan-600 transition-colors">Investraders</a>
            <a href="#circles" className="hover:text-cyan-600 transition-colors">Circles</a>
            <a href="#recognition" className="hover:text-cyan-600 transition-colors">Recognition</a>
            <a href="#join" className="hover:text-cyan-600 transition-colors">Join</a>
          </nav>
        </div>
